...
# 쪼갤 시간 (초) 1일x28
Time_Split_Step_sec = 86400*28 #7200
...
def read_config_file(logger):
    ...
    if streamer_name == '우왁굳':
        ...
        streamer_id = ''
        logger.error('지원하지 않는 스트리머입니다. : ' + streamer_name)
    ...
    try:
        ...
        logger.error('잘못된 검색 시작 날짜입니다. : ' + st_string)
    ...
    try:
        ...
        logger.error(traceback.format_exc())
        logger.error('잘못된 검색 끝 날짜입니다. : ' + et_string)
...
if __name__ == '__main__':
    ...
    try:
        ...
        if not boo:
            ...
            streamer_id, user_name, st_all, et_all = read_config_file(logger)
